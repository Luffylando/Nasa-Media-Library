...
export const SVGWrapper = styled.div`
    ...
    @-webkit-keyframes moveCircle {
        from {
            -webkit-transform: rotate(360deg) translateX(50%) rotate(0deg);
        }
        to {
            -webkit-transform: rotate(0deg) translateX(750px) rotate(0deg);
        }
    }
    @-moz-keyframes moveCircle {
        from {
            -moz-transform: rotate(360deg) translateX(750px) rotate(0deg);
        }
        to {
            -moz-transform: rotate(0deg) translateX(750px) rotate(0deg);
        }
    }
    @-o-keyframes moveCircle {
        from {
            -o-transform: rotate(360deg) translateX(750px) rotate(0deg);
        }
        to {
            -o-transform: rotate(0deg) translateX(750px) rotate(0deg);
        }
    }
    @keyframes moveCircle {
        from {
            transform: rotate(360deg) translateX(400px) rotate(0deg);
        }
        to {
